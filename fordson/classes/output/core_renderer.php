...
class core_renderer extends \theme_boost\output\core_renderer {
    ...
    */
    ...
    public function fp_wonderbox() {
        ...
        $createbuttonevent = (empty($PAGE->theme->settings->createbuttonevent)) ? false : $PAGE->theme->settings->createbuttonevent;
		...
		$nav3buttonevent = (empty($PAGE->theme->settings->nav3buttonevent)) ? false : $PAGE->theme->settings->nav3buttonevent;
		
		$hasnavsupicon = (empty($PAGE->theme->settings->navsupicon && isloggedin() && !isguestuser())) ? false : $PAGE->theme->settings->navsupicon;
		$navsupbuttontext = (empty($PAGE->theme->settings->navsupbuttontext)) ? false : format_text($PAGE->theme->settings->navsupbuttontext);
		$navsupbuttonevent = (empty($PAGE->theme->settings->navsupbuttonevent)) ? false : $PAGE->theme->settings->navsupbuttonevent;
        ...
        // If any of the above social networks are true, sets this to true.
        'hasfpiconnav' => ($hasnav1icon || $hasnav2icon || $hasnav3icon || $hasnav4icon || $hasnav5icon || $hasnav6icon || $hasnav7icon || $hasnav8icon || $hascreateicon || $hasslideicon || $hasnavsupicon ) ? true : false, 
        'fpiconnav' => array(
            array(
                'hasicon' => $hasnav1icon,
		 ...
		 'fpiconnavsup' => array(
            array(
                'hasicon' => $hasnavsupicon,
                'linkicon' => $hasnavsupicon,
                'linktext' => $navsupbuttontext,
				'event' => $navsupbuttonevent
            ) ,
        ) ,
