...
$name = 'theme_fordson/nav3buttonevent';
$title = get_string('naviconbuttonevent', 'theme_fordson');
$description = get_string('naviconbuttoneventdesc', 'theme_fordson');
$default =  get_string('naviconbutton3textdefault', 'theme_fordson');
$setting = new admin_setting_configtext($name, $title, $description, $default);
$setting->set_updatedcallback('theme_reset_all_caches');
$page->add($setting);
...
// This is the descriptor for icon sup
$name = 'theme_fordson/naviconsupinfo';
$heading = 'Homepage Icone Suporte';
$information = '';
$setting = new admin_setting_heading($name, $heading, $information);
$page->add($setting);

$name = 'theme_fordson/navsupicon';
$title = get_string('navicon', 'theme_fordson');
$description = get_string('navicondesc', 'theme_fordson');
$default = 'Vazio';
$setting = new admin_setting_configtext($name, $title, $description, $default);
...
$name = 'theme_fordson/navsupbuttontext';
$title = get_string('naviconbuttontext', 'theme_fordson');
$description = get_string('naviconbuttontextdesc', 'theme_fordson');
$default = 'Suporte';
$setting = new admin_setting_configtext($name, $title, $description, $default);
...
$name = 'theme_fordson/navsupbuttonevent';
$title = get_string('naviconbuttonevent', 'theme_fordson');
$description = get_string('naviconbuttoneventdesc', 'theme_fordson');
$default =  '';
$setting = new admin_setting_configtext($name, $title, $description, $default);
